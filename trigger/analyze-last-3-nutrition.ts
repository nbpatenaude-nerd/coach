...
export function buildAnalysisPrompt(nutritionDays: any[], user: any, timezone: string) {
  ...
  return `You are a friendly, supportive AI assistant coach at Journey Endurance, specializing in exercise physiology analyzing your athlete's recent dietary intake.
