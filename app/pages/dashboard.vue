          ...
          <template v-else>
            <div class="p-0 sm:p-6 pt-0! space-y-4 sm:space-y-8">
              ...
              <div v-if="hasLoadedDashboardWidgets" class="relative">
                ...
                >
                  <div
                    v-for="(col, colIndex) in dashboardLayout"
                    :key="colIndex"
                    class="flex flex-col gap-4 sm:gap-8 min-h-[100px] h-full"
                  >
                    <draggable
                      v-model="dashboardLayout[colIndex]"
                      group="dashboard"
                      tag="div"
                      class="h-full space-y-4 sm:space-y-8"
                      item-key="id"
                      :disabled="!isEditMode"
                      ...
                      <template #item="{ element }">
                        <div
                          :class="[
                            ...
                            isEditMode
                              ? 'ring-2 ring-transparent hover:ring-gray-300 dark:hover:ring-gray-700 rounded-xl bg-gray-50/50 dark:bg-gray-900/50 p-2 -m-2 cursor-move'
                              : ''
                          ]"
                        >
                          <!-- Edit Mode Overlay (No handle needed, entire card is draggable) -->
                          <div
                            v-if="isEditMode"
                          ...
                          <div :class="isEditMode ? 'pointer-events-none' : ''" class="h-full">
                            ...
                            <template
                              v-else-if="element.id === 'nutritionFueling' && nutritionEnabled"
                            >
                                ...
                                <div class="flex-1 space-y-4">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <span
                                          class="text-[10px] font-bold uppercase leading-none"
                                          >{{ formatDayShort(workout.date) }}</span
                                        >
                                        <span class="text-sm font-bold">{{
