...
[Garmin Connect](https://connect.garmin.com) provides high-fidelity training and wellness data. While you can sync activities via Strava, connecting Garmin directly gives Journey Endurance access to advanced recovery metrics.
