...
description: Learn how to connect Journey Endurance to Telegram and use it for quick training insights and analysis.
---

The Journey Endurance Telegram integration allows you to chat with your coach directly from your favorite messaging app. It's perfect for quick questions about your training, nutrition, or checking your recovery status on the go.

## 1. Setup Guide

To link your Journey Endurance account to Telegram:
...
- `/roominfo`: Shows the current Chat Room ID. Journey Endurance organizes conversations into "Rooms" (sessions) to maintain context.

## 3. How it Works

### Chat Sessions

To keep your conversations focused and efficient, Journey Endurance uses **Session Rooms**.
...
You can ask anything you would normally ask in the main Journey Endurance Chat:
