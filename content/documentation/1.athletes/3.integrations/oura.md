...
description: Deeply integrate your Oura Ring recovery and readiness data into Journey Endurance.
---

The [Oura Ring](https://ouraring.com) is our most detailed source for recovery and readiness data. Journey Endurance integrates deeply with Oura to help you understand your body's adaptation to training.
...
- Open the Oura app to confirm the data exists, then **Sync** in Journey Endurance

### Connecting multiple wellness devices

If you also connect Garmin or WHOOP, Journey Endurance prioritizes the most recent data. For consistent trends, one primary wellness source is recommended.
