...
description: Use Journey Endurance Coaching Platform with Cursor and other AI tools through the Model Context Protocol (MCP) server.
---

Journey Endurance Coaching Platform includes a remote **MCP server** that lets supported AI assistants access your training data securely. Instead of copying workout details into a chat window, your assistant can read your plan, log nutrition, and help manage your schedule directly.
...
2. Add the Journey Endurance Coaching Platform server:
...
4. When Cursor connects, your browser opens the Journey Endurance Coaching Platform sign-in and consent screen.
5. Review the requested permissions and click **Allow**.

::alert{type="success"}
Success: After authorization, Cursor can call Journey Endurance Coaching Platform tools on your behalf. Try asking it about your upcoming workouts or recovery status.
::
...
1. Go to **Settings → Apps** in Journey Endurance Coaching Platform.
...
- **Use the in-app coach too** — MCP and the Journey Endurance Coaching Platform chat share the same underlying data. Use whichever interface fits the moment.

## Troubleshooting

### Cursor shows "Unauthorized" or won't connect

- Sign out and back in to Journey Endurance Coaching Platform, then try connecting again.
...
- Verify the data exists in your Journey Endurance Coaching Platform dashboard first.
