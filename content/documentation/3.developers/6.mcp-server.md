---
title: MCP Server
description: Connect AI assistants to Journey Endurance Coaching Platform via the remote Model Context Protocol (MCP) server with OAuth 2.0 and PKCE.
---

Journey Endurance Coaching Platform exposes a remote MCP server so tools like Cursor can read and write your training data on your behalf. The endpoint uses OAuth 2.0 with PKCE and the same permission scopes as the REST API.
