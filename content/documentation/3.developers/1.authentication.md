...
Journey Endurance uses standard OAuth 2.0 with **PKCE (Proof Key for Code Exchange)** to secure user data. This ensures that third-party applications can securely access athlete data with explicit permission.
