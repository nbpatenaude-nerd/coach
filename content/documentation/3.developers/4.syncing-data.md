---
title: Syncing Data
description: Learn how to sync activities, wellness metrics, and nutrition logs to Journey Endurance.
---

This guide explains how to sync third-party data—including activities, wellness metrics, and nutrition logs—to Journey Endurance via our OAuth 2.0 API.
...
Journey Endurance is built to process high-resolution training data. We recommend uploading original `.fit` files whenever possible.
...
```bash
curl -X POST https://app.journeyendurance.ca/api/workouts/upload-fit
...
Use this endpoint to sync daily health indicators. Journey Endurance uses these to adjust the athlete's recovery capacity scores.
